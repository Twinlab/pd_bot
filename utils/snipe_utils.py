...
async def show_sniped_message(ctx):
    ...
    try:
        ...
        if snipe_data.get('has_attachments', False) and snipe_data.get('attachments'):
            ...
            if not snipe_data['content'] and len(attachments) == 1 and attachments[0].get('is_image'):
            ...
            for i, attachment in enumerate(attachments):
                ...
                attachment_info.append(f"[{attachment['filename']}]({attachment['url']}) {type_info} {size_info}")
