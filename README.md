...
- Публичный `/profile` с привязкой Dota 2 и FACEIT по ссылке, личным предпросмотром и управлением аккаунтами
- Объявления о новых возможностях в главном канале — по авторскому тексту релиза, без повторов при рестартах
...
- Развлекательные команды, включая `/tyan` — дневную тянку с историей антиповторов и редкими событиями
