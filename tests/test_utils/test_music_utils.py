...
from utils.music.config import COLORS, YDL_OPTS_BASE
...
def test_create_embed_with_thumbnail():
...
def test_create_embed_with_footer():
...
def test_create_embed_with_author_string():
...
def test_create_embed_with_author_dict():
...
def test_create_embed_with_unknown_kwargs():
